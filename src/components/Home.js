  ...
  render() {
    return (
      <div className="main-content home">
        ...
        <Link to="teachers/HTML/Tommy Jones"> Tommy Jones</Link>
        <Link to="teachers/Fortran/Eren Yaeger">Eren Yaeger</Link>
        <Link to="teachers/CSS/Mikasa Ackermann">Mikasa Ackermann</Link>
